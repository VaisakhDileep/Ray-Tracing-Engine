...
Description : Demonstrates diffuse light.
*/
...
void paint()
{
    shared_ptr<checker_texture> checker_pattern {make_shared<checker_texture>(colour_3d {255, 128, 0}.convert_0_255_to_0_1(), colour_3d {255, 0, 0}.convert_0_255_to_0_1(), 0.1)};

    shared_ptr<diffuse_light> star {make_shared<diffuse_light>(colour_3d {255, 255, 50}.convert_0_255_to_0_1())};

    hitable_list world {vector<shared_ptr<hitable>> {make_shared<sphere>(point_3d {0, 0, -1}, 0.5, star), make_shared<sphere>(point_3d {0, -100000.5, -1}, 100000, make_shared<lambertian>(checker_pattern))}};
