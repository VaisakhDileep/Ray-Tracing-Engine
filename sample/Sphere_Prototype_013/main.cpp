...
Description : Demonstrates the de-focus blur property in the camera class.
*/
...
void paint()
{
    hitable_list world {vector<shared_ptr<hitable>> {make_shared<sphere>(point_3d {0, 0, -1}, 0.5, make_shared<lambertian>(colour_3d {250, 128, 114}.convert_0_255_to_0_1())), make_shared<sphere>(point_3d {0, 0, -2}, 0.5, make_shared<lambertian>(colour_3d {112, 128, 144}.convert_0_255_to_0_1())), make_shared<sphere>(point_3d {0, 0, -3}, 0.5, make_shared<lambertian>(colour_3d {255, 105, 180}.convert_0_255_to_0_1())), make_shared<sphere>(point_3d {0, -100000.5, -1}, 100000, make_shared<lambertian>(colour_3d {12, 157, 240}.convert_0_255_to_0_1()))}};
    ...
    camera cam {look_from, look_at, vector_3d {0, 1, 0}, 45, static_cast<double>(width) / static_cast<double>(height), aperture, focus_distance};
