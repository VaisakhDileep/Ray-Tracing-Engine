...
Description : Demonstrates checker
*/
...
void paint()
{
    shared_ptr<checker_texture> checker_pattern {make_shared<checker_texture>(colour_3d {1, 1, 1}, colour_3d {0, 0, 0}, 0.1)};

    hitable_list world {vector<shared_ptr<hitable>> {make_shared<sphere>(point_3d {0, -100000.5, -1}, 100000, make_shared<lambertian>(checker_pattern))}};

    ofstream out_file {"sphere.ppm"};

    int width {800}, height {400}, samples_per_pixel {100}, max_depth {50};
