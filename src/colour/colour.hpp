...
void write_colour_0_1_format(ofstream &out_file, const colour_3d pixel, double gama_correction);

void write_colour_0_1_format(ofstream &out_file, const colour_3d pixel, const int samples_per_pixel, double gama_correction);
